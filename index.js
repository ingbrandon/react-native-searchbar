...
export default class Search extends Component {
  ...
  componentDidMount(){
    ...
    this.setState({input:ValueTextDefault?ValueTextDefault:''})
  }
  ...
  render = () => {
    ...
    return (
      <Animated.View
        ...
        {this.state.show && (
          <View style={[styles.navWrapper, { backgroundColor },containerStyle]}>
            {Platform.OS === 'ios' &&
              iOSPadding && <View style={{ height: 20 }} />}
            <View
              style={[
                styles.nav,
                { height: (Platform.OS === 'ios' ? 52 : heightCustomer) + heightAdjust }
              ]}>
              {!hideBack && (
                <TouchableOpacity
                  accessible={true}
              ...
              <View>
                <TextInput
                value={ValueTextDefault?ValueTextDefault:'null'}
                ...
                onPress={
                  hideX || this.state.input === '' ? null : this._handleX
...

                    {
                      ...
                      <Icon
                        name={nameIconRight?nameIconRight:'delete'}
                        size={rightIconSize}
                        style={{
                          color:
